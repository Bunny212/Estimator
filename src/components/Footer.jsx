                        ...
                        <footer className="bg-white rounded-lg  dark:bg-gray-900 m-4 " >
                            <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
                                <div className="sm:flex sm:items-center sm:justify-between">
                                    <a href="https://cyclewalay.com/" className="flex items-center mb-4 sm:mb-0">
                                ...
                                <span className="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://cyclewalay.com/" className="hover:underline">cyclewalay.com</a>. All Rights Reserved.</span>
                            </div>
                        </footer>
                    </div>
                )
